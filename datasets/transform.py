...
LastEditTime: 2024-11-14 10:52:05
...
class RandomFlipOrRotate(object):
    def __call__(self, sample):
        img1, img2, mask1, mask2, mask_bin = \
            sample['img1'], sample['img2'], sample['mask1'], sample['mask2'], sample['gt_mask']
        ...
        return {'img1': img1, 'img2': img2, 'mask1': mask1, 'mask2': mask2, 'gt_mask': mask_bin}
