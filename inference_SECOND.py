...
LastEditTime: 2024-11-14 10:42:10
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--load_from", type=str,
                            default=r"D:\2_Experiments\3_Change_Detection\EGMS-Net\checkpoints\SECOND\EGMSNet\resnet34\epoch51_Score35.16_mIOU70.70_Sek19.93_Fscd59.61_OA85.61.pth")
...
def inference(args):
    ...
    model = Net(args.backbone, args.pretrained, len(ChangeDetection_SECOND.CLASSES)-1, args.lightweight, args.M, args.Lambda)
