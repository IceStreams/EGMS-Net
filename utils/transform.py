...
LastEditTime: 2024-11-14 10:45:16
...
def rand_flip_MCD5(img1, img2, label1, label2, label3):
    r = random.random()
    # showIMG(img.transpose((1, 2, 0)))
    if r < 0.25:
        return img1, img2, label1, label2, label3
    elif r < 0.5:
        return np.flip(img1, axis=0).copy(), np.flip(img2, axis=0).copy(), np.flip(label1, axis=0).copy(), np.flip(label2, axis=0).copy(), np.flip(label3, axis=0).copy()
    elif r < 0.75:
        return np.flip(img1, axis=1).copy(), np.flip(img2, axis=1).copy(), np.flip(label1, axis=1).copy(), np.flip(label2, axis=1).copy(), np.flip(label3, axis=1).copy()
    else:
        return img1[::-1, ::-1, :].copy(), img2[::-1, ::-1, :].copy(), label1[::-1, ::-1].copy(), label2[::-1, ::-1].copy(), label3[::-1, ::-1].copy()
...
def rand_rot90_MCD5(img1, img2, label1, label2, label3):
    r = random.random()
    # showIMG(img.transpose((1, 2, 0)))
    if r < 0.5:
        return img1, img2, label1, label2, label3
...
def rand_rot90_flip_MCD5(img1, img2, label1, label2, label3):
    img1, img2, label1, label2, label3 = rand_rot90_MCD5(img1, img2, label1, label2, label3)
    return rand_flip_MCD5(img1, img2, label1, label2, label3)
