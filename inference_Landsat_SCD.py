...
LastEditTime: 2024-11-14 11:17:38
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--data_root", type=str, default=r"D:\2_Experiments\3_Change_Detection\1_dataset\Landsat-SCD")
        parser.add_argument("--load_from", type=str,
                            default=r"D:\2_Experiments\3_Change_Detection\EGMS-Net\checkpoints\Landsat_SCD\EGMSNet\resnet34\epoch98_Score78.72_mIOU92.72_Sek72.71_Fscd93.38_OA97.58.pth")
...
def inference(args):
    ...
    model = Net(args.backbone, args.pretrained, len(ChangeDetection_Landsat_SCD.CLASSES)-1, args.lightweight, args.M, args.Lambda)
