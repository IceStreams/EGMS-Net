...
LastEditTime: 2024-11-14 11:06:34
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--data_name", type=str, default=r"HiUCDmini")
        ...
        parser.add_argument("--warmup", dest="warmup", action="store_true", help='warm up') #默认不使用warmup
...
class Trainer:
    def __init__(self, args):
        ...
        trainset = ChangeDetection_HiUCDmini(root=args.data_root, mode="train")
        valset = ChangeDetection_HiUCDmini(root=args.data_root, mode="val")
        ...
        self.model = Net(args.backbone, args.pretrained, len(trainset.CLASSES)-1, args.lightweight, args.M, args.Lambda)
    ...
    def validation(self, epoch):
        ...
        with torch.no_grad():
            for img1, img2, mask1, mask2, mask_bn, _ in tbar:
                ...
                tbar.set_description("miou: %.4f, sek: %.4f, score: %.4f, Fscd: %.4f, OA: %.4f, SC_Precision: %.4f, SC_Recall: %.4f" % (miou, sek, score, Fscd, OA, SC_Precision, SC_Recall))
